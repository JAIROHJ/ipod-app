        ...
        return (
            <div style={cssProp} className="information-container">
                <div className="info-div">
                    ...
                    <p>Github-Link : <a href="https://github.com/JAIROHJ/ipod-app">iPod</a> 
                    </p>
                    <p>Hosting-Link : <a href="https://github.com/JAIROHJ/ipod-app">iPod-Hosted</a> 
                    </p>
                    <p>App Developed by : <a href="https://github.com/JAIROHJ">Jaibhagwan Rohj</a></p>
                    <p>credits : Coding Ninjas, rohaj</p>
                </div>
